// Method dispatch, isolated from allocation. Upstream's counts scaled down by
// ten so a three-repeat run of two builds is minutes rather than an hour; the
// dispatch pattern is unchanged.
class Toggle {
